@employee1 = Employee.create!(email: "user@example.com",
                    password: "password",
...
@adminemployee = AdminUser.create!(email: "admin@example.com",
                        password: "password",
                        password_confirmation: "password",
                        first_name: "Admin",
                        last_name: "Smith",
