...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their own posts' do
      ...
      other_user = User.create(first_name: 'other', last_name: 'user', email: 'other@asdf.com', password: 'asdfasdf', password_confirmation: 'asdfasdf', phone: "5555555555")
  ...
  describe 'new' do
    ...
    it 'has a link from home page' do
      employee = Employee.create(first_name: 'employee', last_name: 'user', email: 'employee@example.com', password: 'asdfasdf', password_confirmation: 'asdfasdf', phone: "5555555555")
